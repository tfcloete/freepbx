...
RUN /etc/init.d/mysql start && \
    ...
    fwconsole ma downloadinstall backup bulkhandler queues findmefollow ringgroups timeconditions ivr restapi cel configedit asteriskinfo certman ucp webrtc && \
